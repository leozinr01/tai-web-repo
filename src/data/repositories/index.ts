 ...
 * workOrders, appointments, reports) usam o Supabase do projeto (schema
 * legado real: Empresas, User, Sala, Maquinas, Apontamentos, "Ordem de
 * serviço", "Relatório", "OEE geral", variables, dashboard_configs).
 */
