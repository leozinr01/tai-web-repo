...
export const seedSectors: Sector[] = [
  ...
  { id: "sector_impressao", companyId: "company_tai", name: "Impressao" },
  { id: "sector_materia_prima", companyId: "company_tai", name: "Materia prima" },
  { id: "sector_producao", companyId: "company_tai", name: "Producao" },
  ...
  { id: "sector_elder_1", companyId: "company_elder_marx", name: "Producao" },
  { id: "sector_elder_2", companyId: "company_elder_marx", name: "Manutencao" },
