      ...
      <form id="work-order-form" onSubmit={handleSubmit(handleFormSubmit)} noValidate className="space-y-3">
            ...
            <Controller
              ...
              render={({ field }) => (
                <SearchableSelect
                  ...
                  className="h-auto rounded-lg px-4 py-2.5 text-sm font-bold"
                />
              )}
            />
        ...
        <div>
          ...
          <textarea
            ...
            className="h-24 w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-muted focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand"
